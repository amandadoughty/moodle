 ...
 */
class block_cul_upcoming extends block_base {

    /**
     * Initialise the block.
     */
    public function init() {
        $this->title = get_string('pluginname', 'block_cul_upcoming');
    }
    ...
    public function get_content() {
        ...
        $this->content->footer = html_writer::div(
            html_writer::link($url, get_string('gotocalendar', 'block_cul_upcoming')),
            'gotocal'
        );
    ...
    public static function get_upcoming_content($events, $linkhref = null, $showcourselink = false) {
        debugging(
                ...
                'Please see block_cul_upcoming::get_content() for the correct API usage.',
                DEBUG_DEVELOPER
            );
