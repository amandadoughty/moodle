...
* Rename the culcourse_dashboard/ folder to the name of your module (eg "widget").
...
all the instances of the string "culcourse_dashboard" to your module name
(eg "widget"). If you are using Linux, you can use the following command
$ find . -type f -exec sed -i 's/culcourse_dashboard/widget/g' {} \;

* Rename the file lang/en/culcourse_dashboard.php to lang/en/widget.php
where "widget" is the name of your module. Also rename block_culcourse_dashboard.php
...
and you should find that this culcourse_dashboard has been added to the list of
installed modules.
