...
/**
 * Strings for component 'block_culcourse_dashboard', language 'en'
 *
...
$string['culcourse_dashboard:addinstance'] = 'Add a CUL Course Dashboard block';
$string['culcourse_dashboard:myaddinstance'] = 'Add a CUL Course Dashboard block to my moodle';
$string['culcourse_dashboard:viewallphotoboard'] = 'View all Photoboards';
$string['culcourse_dashboard:viewphotoboard'] = 'View Photoboard';
$string['forum-posts'] = 'Forum Posts';
$string['headerconfig'] = 'Config section header';
$string['media'] = 'Media Gallery';
$string['moduleleader'] = ' (Module Leader)';
$string['moduleleaders'] = 'Module Leaders';
$string['modulesummary'] = 'Module Summary';
$string['no-readinglist'] = 'There are no reading lists matching this module';
$string['error-readinglist'] = 'Sorry - an error occurred while fetching the reading list data';
...
$string['no-view-participantlist'] = 'Sorry, you are unable to view module participant list';
$string['no-view-photoboard'] = 'Sorry, you are unable to view module photoboards';
$string['no-timetable'] = 'Timetable link unavailable';
...
$string['config_timetable_weekoptions'] = 'Timetable Week Options';
$string['config_timetable_weekoptions_desc'] = 'Timetable Week Options';
$string['config_timetable_formatoptions'] = 'Timetable Format Options';
$string['config_timetable_formatoptions_desc'] = 'Timetable Format Options';
...
// Show photoboard.
$string['setshowphotoboard'] = 'Show the photoboard';
$string['setshowphotoboard_help'] = 'States if the photoboard will be shown.';
$string['defaultshowphotoboard'] = 'Show the photoboard';
$string['defaultshowphotoboard_desc'] = 'States if the photoboard will be shown.';
...
$string['setselectmoduleleaders'] = 'Select the module leaders';
$string['setselectmoduleleaders_help'] = 'Identifies the lecturers on the course who are module leaders.';
$string['defaultselectmoduleleaders'] = 'Select the module leaders';
$string['defaultselectmoduleleaders_desc'] = 'Identifies the lecturers on the course who are module leaders.';
