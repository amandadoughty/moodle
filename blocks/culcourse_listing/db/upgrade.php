...
function xmldb_block_culcourse_listing_upgrade($oldversion = 0) {
    ...
    if($oldversion < 2017020100) {
        ...
        $table->add_field('id', XMLDB_TYPE_INTEGER, '9', XMLDB_UNSIGNED, 
            XMLDB_NOTNULL, XMLDB_SEQUENCE, null);

        $table->add_field('name', XMLDB_TYPE_CHAR, '255', 
            XMLDB_UNSIGNED, XMLDB_NOTNULL, null, null);

        $table->add_field('type', XMLDB_TYPE_INTEGER, '9', 
            XMLDB_UNSIGNED, XMLDB_NOTNULL, null, 0);

        $table->add_field('startdate', XMLDB_TYPE_INTEGER, '9', 
            XMLDB_UNSIGNED, XMLDB_NOTNULL, null, null);

        $table->add_field('enddate', XMLDB_TYPE_INTEGER, '9', 
            XMLDB_UNSIGNED, XMLDB_NOTNULL, null, null);
