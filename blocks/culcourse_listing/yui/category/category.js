YUI.add('moodle-block_culcourse_listing-category', function(Y) {
     ...
     */
    setup_keyboard_listeners: function() {
    ...
    toggle_category_expansion: function(e) {
     ...
     */
    run_expansion: function(categorynode) {
    ...
    collapse_expand_all: function(e) {
    ...
    collapse_all: function(ancestor) {
        var finalcollapses = [];
    ...
    update_collapsible_actions: function(ancestor) {
        if (!ancestor) {
     ...
     */
    add_animation: function(childnode) {
