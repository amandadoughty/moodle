...
and you should find that this culrollover has been added to the list of
installed modules.
...
[![Build Status](https://travis-ci.org/danielneis/moodle-block_culrollover.svg?branch=master)](https://travis-ci.org/danielneis/moodle-block_culrollover)
