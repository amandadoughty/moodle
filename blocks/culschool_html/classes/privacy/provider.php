...
/**
 * Privacy Subsystem implementation for block_culschool_html.
 *
...
namespace block_culschool_html\privacy;
    ...
    public static function get_contexts_for_userid(int $userid) : \core_privacy\local\request\contextlist {
        ...
        $sql = "SELECT c.id
            ...
            INNER JOIN {context} bpc ON bpc.id = b.parentcontextid
                 WHERE b.blockname = 'culschool_html'
    ...
    public static function export_user_data(approved_contextlist $contextlist) {
        ...
        $sql = "SELECT
            ...
            INNER JOIN {block_instances} bi ON bi.id = c.instanceid AND c.contextlevel = :contextlevel
                 WHERE bi.blockname = 'culschool_html'
                   AND(
                    c.id {$contextsql}
                )
        ";
        ...
        foreach ($instances as $instance) {
            ...
            $block = block_instance('culschool_html', $instance);
            ...
            $html = writer::with_context($context)
                ->rewrite_pluginfile_urls([], 'block_culschool_html', 'content', null, $block->config->text);
