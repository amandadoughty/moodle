...
class format_cul_dashboard {
    ...
    public function set_dashboard_edit_options(&$courseformatoptionsedit) {
        ...
        if (count($lecturers)) {
            ...
            $selectbox[0] = get_string('nolecturers', 'format_cul');
        }

        $dashboardoptionsedit['selectmoduleleaders'] = [
            'label' => new lang_string('setselectmoduleleaders', 'format_cul'),
   ...
   /**
     ...
     * TODO
     */
    static function format_cul_get_modfullnames($course) {
    ...
    static function format_cul_get_ltitypes($course) {
        global $DB;
