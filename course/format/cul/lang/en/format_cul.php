...
/**
 * Strings for component 'format_cul', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package   format_cul
...
$string['pluginname'] = 'CUL format';
$string['section0name'] = 'General';
$string['page-course-view-cul'] = 'Any course main page in CUL format';
$string['page-course-view-cul-x'] = 'Any course page in CUL format';
