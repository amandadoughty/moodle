...
trait format_weeks_trait {
     ...
     * @return bool
     */
    public function format_weeks_uses_sections() {
        return true;
    }
     ...
     */
    public function format_weeks_get_section_name($section) {
     ...
     */
    public function format_weeks_get_default_section_name($section) {
     ...
     *     'navigation' (bool) if true and section has no separate page, the function format_weeks_returns null
     *     'sr' (int) used by multipage formats to specify to which section to return
     * @return null|moodle_url
     */
    public function format_weeks_get_view_url($section, $options = array()) {
        global $CFG;
     ...
     * @return stdClass
     */
    public function format_weeks_supports_ajax() {
     ...
     */
    public function format_weeks_extend_course_navigation($navigation, navigation_node $node) {
        global $PAGE;
     ...
     */
    function format_weeks_ajax_section_move() {
        global $PAGE;
        $titles = array();
        $current = -1;
        $course = $this->get_course();
     ...
     */
    public function format_weeks_get_default_blocks() {
        return array(
     ...
     */
    public function format_weeks_course_format_options($foreditform = false) {
     ...
     *
     * This function format_weeks_is called from {@link course_edit_form::definition_after_data()}.
     *
     * @param MoodleQuickForm $mform form the elements are added to.
     * @param bool $forsection 'true' if this is a section edit form, 'false' if this is course edit form.
     * @return array array of references to the added form elements.
     */
    public function format_weeks_create_edit_form_elements(&$mform, $forsection = false) {
        global $COURSE;
     ...
     * @param stdClass $oldcourse if this function format_weeks_is called from {@link update_course()}
     *     this object contains information about the course before update
     * @return bool whether there were any changes to the options values
     */
    public function format_weeks_update_course_format_options($data, $oldcourse = null) {
        global $DB;
        $data = (array)$data;
        if ($oldcourse !== null) {
     ...
     * @return bool
     */
    public function format_weeks_is_section_current($section) {
        if (is_object($section)) {
            $sectionnum = $section->section;
        } else {
            $sectionnum = $section;
     ...
     *
     * Do not call this function format_weeks_directly, instead use {@link course_can_delete_section()}
     *
     * @param int|stdClass|section_info $section
     * @return bool
     */
    public function format_weeks_can_delete_section($section) {
        return true;
    }
     ...
     */
    public function format_weeks_inplace_editable_render_section_name($section, $linkifneeded = true,
     ...
     * @return int
     */
    public function format_weeks_get_default_course_enddate($mform, $fieldnames = array()) {
     ...
     * @return bool
     */
    public function format_weeks_supports_news() {
        return true;
    }
     ...
     * @return bool
     */
    public function format_weeks_allow_stealth_module_visibility($cm, $section) {
        // Allow the third visibility state inside visible sections or in section 0.
        return !$section->section || $section->visible;
    }

    public function format_weeks_section_action($section, $action, $sr) {
        global $PAGE;
