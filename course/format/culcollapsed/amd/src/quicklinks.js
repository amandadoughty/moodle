...
/**
  * @module format_culcollapsed/quicklinks
  */
define(['jquery','core/notification', 'core/templates'], function($, notification, templates) {
    ...
    var changeVisibility = function(link, courseid, name, value) {
        ...
        .done(function(data) {
            try {
                ...
                templates.render('format_culcollapsed/editlink', data).done(function(html, js) {
    ...
    return /** @alias module:format_culcollapsed/quicklinks */ {
        /**
