...
$top = optional_param('top', false, PARAM_BOOL);
...
if (isset($courseformatoptions['numsections'])) {
    if ($increase) {
        ...
        if ($top) {
            // Move top section to bottom so that it is the one that is orphaned.
            $sectionnum = 1;            
            $destsection = $courseformatoptions['numsections'];
...
if ($top) {
    $url->set_anchor('changenumsectionstop');
} else {
