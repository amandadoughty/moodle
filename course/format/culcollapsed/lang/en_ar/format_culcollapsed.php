...
// Used in format.php.
$string['culcollapsedsidewidthlang'] = 'en_ar-40px';
...
$string['culcollapsedopened'] = 'Untie';
$string['culcollapsedclosed'] = 'Tie';
...
// Capabilities.
$string['culcollapsed:changelayout'] = 'Change or reset thee layout';
$string['culcollapsed:changecolour'] = 'Change or reset thee colour';
$string['culcollapsed:changetogglealignment'] = 'Change or reset thee toggle alignment';
$string['culcollapsed:changetoggleiconset'] = 'Change or reset thee toggle icon set';
