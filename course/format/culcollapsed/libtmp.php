...
class format_culcollapsed extends format_base {
    ...
    protected function __construct($format, $courseid) {
        ...
        if (($this->settings['layoutstructure'] == 1) || ($this->settings['layoutstructure'] == 4)) {
            $this->baseformat = 'format_topics';
        } else {
            $this->baseformat = 'format_weeks';
        }
    ...
    public function get_default_section_name($section) {
        if ($section->section == 0) {
            ...
            return get_string('section0name', 'format_culcollapsed');
        } else {
    ...
    public function course_format_options($foreditform = false) {
        ...
        if ($foreditform && !isset($courseformatoptions['coursedisplay']['label'])) {
            $courseformatoptionsedit = array(
                ...
                'automaticenddate' => array(
                    'label' => new lang_string('automaticenddate', 'format_culcollapsed'),
    ...
    public static function update_end_date($courseid) {
        ...
        $format = new format_culcollapsed('weeks', $courseid);
