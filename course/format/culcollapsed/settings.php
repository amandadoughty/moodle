...
if ($ADMIN->fulltree) {
    $settings->add(new admin_setting_heading('format_culcollapsed_defaults',
            get_string('defaultheadingsub', 'format_culcollapsed'),
    ...
    /* Structure configuration.
      ...
      after installing this functionality introduced in CONTRIB-3378. */
    $name = 'format_culcollapsed/defaultlayoutstructure';
    ...
    // 1 => No.
    // 2 => Yes.
    $name = 'format_culcollapsed/defaultshowsectionsummary';
    $title = get_string('defaultshowsectionsummary', 'format_culcollapsed');
    $description = get_string('defaultshowsectionsummary_desc', 'format_culcollapsed');
    $default = 1;
    $choices = array(
        1 => new lang_string('no'),
        2 => new lang_string('yes')
    ...
    $settings->add(new admin_setting_heading('format_culcollapsed_configuration',
            get_string('configurationheadingsub', 'format_culcollapsed'),
            format_text(get_string('configurationheadingsubdesc', 'format_culcollapsed'), FORMAT_MARKDOWN)));

    /* Toggle persistence - 1 = on, 0 = off.  You may wish to disable for an AJAX performance increase.
      Note: If turning persistence off remove any rows containing 'culcollapsed_toggle_x' in the 'name' field
      of the 'user_preferences' table in the database.  Where the 'x' in 'culcollapsed_toggle_x' will be
      a course id. */
    $name = 'format_culcollapsed/defaulttogglepersistence';
    $title = get_string('defaulttogglepersistence', 'format_culcollapsed');
    $description = get_string('defaulttogglepersistence_desc', 'format_culcollapsed');
    $default = 1;
    $choices = array(
    ...
    // 0 => All closed.
    // 1 => All open.
    $name = 'format_culcollapsed/defaultuserpreference';
    $title = get_string('defaultuserpreference', 'format_culcollapsed');
    $description = get_string('defaultuserpreference_desc', 'format_culcollapsed');
    $default = 0;
    $choices = array(
        0 => new lang_string('culcollapsedclosed', 'format_culcollapsed'),
        1 => new lang_string('culcollapsedopened', 'format_culcollapsed')
    );
    $settings->add(new admin_setting_configselect($name, $title, $description, $default, $choices));
