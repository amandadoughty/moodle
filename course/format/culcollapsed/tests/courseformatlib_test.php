 ...
 * @group format_culcollapsed
 */
class format_culcollapsed_courseformatlib_testcase extends advanced_testcase {
    ...
    public function test_set_up() {
        ...
        $this->assertEquals('1.0', get_config('format_culcollapsed', 'defaulttgfgopacity'));
        $this->assertEquals('1.0', get_config('format_culcollapsed', 'defaulttgfghvropacity'));
        $this->assertEquals('1.0', get_config('format_culcollapsed', 'defaulttgbgopacity'));
        $this->assertEquals('1.0', get_config('format_culcollapsed', 'defaulttgbghvropacity'));
        ...
        $this->assertEquals('0.5', get_config('format_culcollapsed', 'defaulttgfgopacity'));
        $this->assertEquals('0.6', get_config('format_culcollapsed', 'defaulttgfghvropacity'));
        $this->assertEquals('0.7', get_config('format_culcollapsed', 'defaulttgbgopacity'));
        $this->assertEquals('0.8', get_config('format_culcollapsed', 'defaulttgbghvropacity'));
