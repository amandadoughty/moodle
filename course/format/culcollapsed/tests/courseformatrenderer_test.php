 ...
 */
class format_culcollapsed_courseformatrenderer_testcase extends advanced_testcase {
    ...
    protected function setUp() {
        ...
        global $PAGE;
        $this->outputus = $PAGE->get_renderer('format_culcollapsed');
        // Ref: https://docs.moodle.org/dev/Writing_PHPUnit_tests.
        $this->course = $this->getDataGenerator()->create_course(array('format' => 'culcollapsed', 'numsections' => 1),
