...
===========================
The primary source for downloading this branch of the format is https://moodle.org/plugins/view.php?plugin=format_culcourse
with 'Select Moodle version:' set at 'Moodle 2.8'.

The secondary source is a tagged version with the v2.8 prefix on https://github.com/gjb2048/moodle-format_culcourse/tags

If you download from the development area - https://github.com/gjb2048/moodle-format_culcourse/tree/MOODLE_27 - consider that
...
https://github.com/gjb2048/moodle-format_culcourse and doing a 'Pull Request' so that the rest of the
...
============
 ...
 6. Copy 'culcourse' to '/course/format/' if you have not already done so.
...
4. In '/course/format/' move old 'culcourse' directory to a backup folder outside of Moodle.
...
2. In '/course/format/' move old 'culcourse' directory to a backup folder outside of Moodle.
3. Do not copy in the new version of 'culcourse' yet!  As this will cause the upgrade to fail.
4. Upgrade to Moodle 2.2 first - http://docs.moodle.org/22/en/Upgrading_to_Moodle_2.2.
5. After you have installed Moodle 2.2, now upgrade to Moodle 2.4 with this new culcourse -
   http://docs.moodle.org/24/en/Upgrading_to_Moodle_2.4 - but before initiating the upgrade you can copy the
   new (i.e. this) 'culcourse' folder to '/course/format'.
6. Now follow 'Upgrading from Moodle 2.2' below please.
INFO: Having no 'culcourse' folder in '/course/format' is fine as the courses that use it are not accessed and
...
1.    Put Moodle in 'Maintenance Mode' so that there are no users using it bar you as the administrator - if you have
      not already done so.
2.    In '/course/format/' move old 'culcourse' directory to a backup folder outside of Moodle - if you have not
      already done so.
3.    Copy this new 'culcourse' folder to '/course/format/'.
4.    Upgrade to Moodle 2.4 by being logged in as 'admin' and clicking on 'Home'.  If you have previously upgraded but
      'culcourse' was an old version and the upgrade failed, this should still work.
5.    Follow installation instructions above.
...
1.    In your database:
2.1   Rename the table 'format_culcourse_layout' to 'format_culcourse_settings'.
2.2   With the table 'format_culcourse_settings' change all integer types to signed if using a MySQL database.
2.3   If the table 'format_culcourse_settings' does not exist, then create it and add the following fields
      in this order:
...
2.3.4 'layoutstructure' of type 'TINYINT(1)' type, not null, no auto increment, no zero fill with a default value
      of '1'.
2.4   With the table 'format_culcourse_settings' append three new fields of 'VARCHAR(6)' type, not null, called
      'tgfgcolour', 'tgbgcolour' and 'tgbghvrcolour' in that order with the default values of '000000', 'e2e2f2'
      and 'eeeeff' respectively.
2.5   With the table 'format_culcourse_settings' append a new field 'layoutcolumns' after the 'layoutstructure' field
...
2.5.1 'layoutcolumns' of type 'TINYINT(1)' type, not null, no auto increment, no zero fill with a default value
      of '1'.
2.6   Drop the table 'format_culcourse_cookie_cnsnt'.
...
3. In '/course/format/' remove the folder 'culcourse'.
4. In the database, remove the table 'format_culcourse_settings' along with the entry for 'format_culcourse'
   ('plugin' attribute) in the table 'config_plugins'.  If using the default prefix this will be
   'mdl_format_culcourse_settings' and 'mdl_config_plugins' respectively.
...
the 'toggle all' functionality.  For example:
    ...
    body.jsenabled .course-content ul.culcourse li.section .content .toggle-arrow a.toggle_closed {
        background-image: url([[pix:format_culcourse|arrow_right]]);
    }

    #toggle-all .content .toggle-arrow h4 a.off {
        background-image: url([[pix:format_culcourse|arrow_down]]);
    }
...
3.  Sometimes when restoring a course, it is accessed for the first time and a toggle is clicked a 'Error updating user
    preference 'culcourse_toggle_x'' (where 'x' is the course id as shown in the URL 'id=x') can occur.  I'm not completely sure
...
release area is located on https://moodle.org/plugins/view.php?plugin=format_culcourse.  It is also essential that you are
...
on Moodle tracker 'tracker.moodle.org' ensuring that you chose the 'Non-core contributed modules' and 'Course Format: culcourse'
...
11th December 2014 Version 2.8.1.1
  ...
  2.  Fix CONTRIB-5472.
  3.  Integrated 'Use core required_param for toggle parameters.': https://github.com/gjb2048/moodle-format_culcourse/pull/12
  ...
  4.  Improved HTTP protocol handling in 'setculcoursepref.php'.
...
19th August 2014 Version 2.7.1.4
  1.  Fixed issue #11: Moodle notice - https://github.com/gjb2048/moodle-format_culcourse/issues/11.
...
20th May 2014 Version 2.7.1 - Stable.
  ...
  2.  Fixed CONTRIB-5073 - invisible section causes an error with "culcourse" format.
...
18th December 2013 Version 2.6.1.1
  1.  Fixed issue reported by Graham Woodsford whereby teachers could not create Collapsed Topics courses.  This is because the
      ...
      the 'format/culcourse:changelayout', 'format/culcourse:changecolour', 'format/culcourse:changetogglealignment' and
      'format/culcourse:changetoggleiconset' capabilities.  This also implies that the values of the other settings are wrong,
...
24th October 2013 Version 2.5.3.4
  ...
  3.  Slight optimisation to 'renderer.php' for getting 'format_culcourse' object when already have it.
...
23rd June 2013 - Version 2.5.2
  ...
  9.  Note:  Once you upgrade to this version and beyond then going back will mean loss of the user preferences as you will need to
             remove all 'culcourse_toggle_x' rows from the 'user_preferences' table first.
...
27th April 2013 - Version 2.5.0.2 - Beta
  ...
  2.  Fixed an obscure bug with '$defaultuserpreference' in 'format.php' not being parsed to 'M.format_culcourse.init' in 'module.js'.
...
8th February 2013 - Version 2.4.3
  ...
  6.  Added capabilities 'format/culcourse:changelayout', 'format/culcourse:changecolour', 'format/culcourse:changetogglealignment'
      and 'format/culcourse:changetoggleiconset' to editing teachers and managers such that site administrators can choose to
...
18th October 2012 - Version 2.3.9.1
  ...
  2. Identified that sometimes when restoring a course, it is accessed for the first time and a toggle is clicked a 'Error
     updating user preference 'culcourse_toggle_x'' (where 'x' is the course id as shown in the URL 'id=x') can occur.  I'm not
...
10th September 2012 - Version 2.3.8.1
  1. Fixed 'Warning: Illegal string offset 'defaultblocks' in ...\culcourse\config.php on line 39' issue when
...
3rd September 2012 - Version 2.3.8
 ...
 10. Cherry picked Luiggi's change
     https://github.com/luiggisanso/moodle-format_culcourse/commit/9bd818f5a4efb347aef4f5154ea2930526552bfc
 11. Figured out how to use 'pix:' for URL's in css for the format, so have changed so that the images are now controlled by css classes.  This
     ...
     `body.jsenabled .course-content ul.culcourse li.section .content .toggle a.toggle_open` - For the 'up' arrow in the toggle - original is 24px.
     `body.jsenabled .course-content ul.culcourse li.section .content .toggle a.toggle_closed` - For the 'down' arrow in the toggle - original is 24px.
     `.course-content ul.culcourse li.section .content .toggle a.toggle_closed` - For the 'up' arrow in the toggle when JavaScript is disabled and the toggles default to open.
...
1st August 2012 - Version 2.3.7.2
  ...
  5. Removed 'callback_culcourse_get_section_url' in 'lib.php' because it is no longer required by
     'load_generic_course_sections' in '/lib/navigationlib.php'.
  6. Added 'currentsection' string to '/lang/en/format_culcourse.php' - thanks to [Carlos Kiyan Tsunami](http://moodle.org/mod/forum/discuss.php?d=208066).
...
1st May 2012 - Version 2.3.6 - CONTRIB-3624
  1. Implemented code to facilitate the ability to confirm with the user that it is ok to place the cookie 'mdl_cf_culcourse' on
  ...
  4. A few fixes to changes made in version 2.2.5 where I had renamed table 'format_culcourse_layout' to 'format_culcourse_settings'
     in the code.
...
26th April 2012 - Version 2.3.5 - CONTRIB-3529 - As suggested by [Leonie Vos](http://moodle.org/user/profile.php?id=1435066).
   ...
   5. Renamed 'format_culcourse_layout' table to 'format_culcourse_settings' so that it is a better representation of what it
...
21st March 2012 - Version 2.3.4.2
  1. Received an updated version of 'format_culcourse.php' from Luiggi Sansonetti for the French translation - Merci :).
...
17th March 2012 - Version 2.3.4.1
  ...
  3. Release '2012030100.02' of Moodle 2.3dev converted all tables to have signed integers in the function
     ...
     included 'format_culcourse_layout' because of the code was written.  This made it very difficult for me to create an
     ...
     'format_culcourse_layout' from your database before upgrading.  This is not quite brilliant, but I consider reasonable for
...
14th March 2012 - Version 2.3.4 - BETA - CONTRIB-3520.
  ...
  2. Added the function 'format_culcourse_delete_course' in 'lib.php' which will remove the entry in the 'format_culcourse_layout'
...
1st March 2012 - Version 2.3.3 - Stable
  ...
  2. NOTE: If you have previously installed a Beta or Release Candidate please drop the table 'format_culcourse_layout' before use.
...
NOTE: If uninstallation fails, drop the table 'format_culcourse_layout' and the entry for 'format_culcourse' in the table
...
25th February 2012 - Version 2.3.3 - Release Candidate 1
  ...
  4. If you have previously installed a beta version you will need to drop the table 'format_culcourse_layout' in the database.
  5. If you are a native speaker of a language other than English, I would be grateful of a translation of the new language
     strings in 'lang/en/format_culcourse.php' under the comment 'Layout enhancement - Moodle Tracker CONTRIB-3378'.  Please
...
15th February 2012 - Version 2.3.3 - BETA 7
  1. Added strings for MDL-26105 in format_culcourse.php.
...
12th February 2012 - Version 2.3.3 - BETA 6
  1. Fixed CONTRIB-3283 in lib.js (and hence lib_min.js) for when you are in display only 'Section x' mode and the number of
     ...
     'Jump to...' drop down box does not work.  Leading to having to change the database or the value of 'culcourse' in the URL to
     that of a valid one.
  2. Added 'callback_culcourse_get_section_url' in 'lib.php' for MDL-26477.
...
11th February 2012 - Version 2.3.3 - BETA 5
  ...
  2. If you have previously installed this development, you need to drop the table 'format_culcourse_layout' in your database to
...
12th November 2010 - CONTRIB-1471 & CONTRIB-2497 - Changes as a result of MDL-25072:
  ...
  4. Added the string 'culcoursetogglewidth' to the relevant language file and amended format.php so that
...
17th October 2010 - CONTRIB-1471 - Changes as a result of MDL-14679, MDL-20366 and MDL-24316.
  1. Removed the requirement of needing js-override-culcourse.css - to make things simpler.
