@format @format_culcourse
Feature: Sections can be edited and deleted in culcourse format
  In order to rearrange my course contents
  As a teacher
  I need to edit and Delete culcourse
  ...
  @javascript
  Scenario: Inline edit section name in culcourse format
  ...
  Scenario: Deleting the last section in culcourse format
  ...
  Scenario: Deleting the middle section in culcourse format
