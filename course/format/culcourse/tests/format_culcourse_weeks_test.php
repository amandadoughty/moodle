...
/**
 * format_culcourse related unit tests
 *
...
class format_culcourse_weeks_testcase extends advanced_testcase {
    ...
    public function test_get_section_name() {
        ...
        $numsections = 5;
        $course = $generator->create_course(array('numsections' => $numsections, 'format' => 'culcourse', 'baseclass' => 2),
    ...
    /**
     * Tests for format_culcourse::get_section_name method with modified section names.
     */
    ...
    /**
     * Tests for format_culcourse::get_default_section_name.
     */
    ...
    public function test_update_inplace_editable() {
        ...
        $this->setUser($user);
        $course = $this->getDataGenerator()->create_course(array('numsections' => 5, 'format' => 'culcourse', 'baseclass' => 2),
            array('createsections' => true));
        $section = $DB->get_record('course_sections', array('course' => $course->id, 'section' => 2));

        // Call webservice without necessary permissions.
        try {
            core_external::update_inplace_editable('format_culcourse', 'sectionname', $section->id, 'New section name');
        ...
        $res = core_external::update_inplace_editable('format_culcourse', 'sectionname', $section->id, 'New section name');
    ...
    public function test_inplace_editable() {
        ...
        $tmpl = component_callback('format_culcourse', 'inplace_editable', array('sectionname', $section->id, 'Rename me again'));
    ...
    public function test_get_view_url() {
        ...
        $generator = $this->getDataGenerator();
        $course1 = $generator->create_course(array('format' => 'culcourse', 'baseclass' => 2));
