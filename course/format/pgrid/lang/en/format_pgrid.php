...
$string['pluginname'] = 'Pearson Grid Course format';
...
$string['pgrid:viewallphotoboard'] = 'View all roles in the photoboard';
$string['pgrid:viewphotoboard'] = 'View the photoboard';
...
$string['pgridclosed'] = 'Close all';
$string['pgridopened'] = 'Open all';
...
/***** PRIVACY API *****/
$string['privacy:metadata:preference:format_pgrid_expanded'] = 'The collapsed state of each section in a course.';
$string['privacy:request:preference:format_pgrid_expanded'] = 'You last left the sections in the course "{$a->course}" as "{$a->sectionstates}".';
$string['privacy:metadata:preference:format_pgrid_toggledash'] = 'The collapsed state of the dashboard in a course.';
$string['privacy:request:preference:format_pgrid_toggledash'] = 'You last left the dashboard in the course "{$a->course}" as "{$a->dashboardstate}".';