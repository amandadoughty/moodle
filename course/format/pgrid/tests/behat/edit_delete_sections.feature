@format @format_pgrid
Feature: Sections can be edited and deleted in pgrid format
  ...
  @javascript
  Scenario: Inline edit section name in pgrid format
  ...
  Scenario: Deleting the last section in pgrid format
  ...
  Scenario: Deleting the middle section in pgrid format
  ...
  @javascript
  Scenario: Adding sections in pgrid format
