YUI.add('moodle-format_pgrid-dragdrop', function (Y, NAME) {

/**
 * Dash link drag and drop.
 *
 * @class M.format_pgrid_dragdrop
 */
...
M.format_pgrid = M.format_pgrid || {};
M.format_pgrid.init_quicklinkdd = function(params) {
...
Y.extend(ACTIVITYLINK, M.core.dragdrop, {
    ...
    NAME : 'format_pgrid_activitylinkdd',
        ATTRS: {
        courseid: {
            value: null
        },
...
M.format_pgrid = M.format_pgrid || {};
M.format_pgrid.init_activitylinkdd = function(params) {
