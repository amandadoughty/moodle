...
$string['pluginname'] = 'Grades & feedback report';
...
$string['grade'] = 'Grade - ';
$string['grademark'] = 'Feedback in Turnitin (if provided)';
...
$string['privacy:metadata:preference:gradereport_culuser_view_user'] = 'Whether to view report as current user or another user in the gradebook reports';
