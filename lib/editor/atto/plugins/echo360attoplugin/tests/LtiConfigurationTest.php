...
function lti_get_ims_role($user, $cmid, $course, $is_lti_2){
  return LtiConfigurationTest::$mock_ims_role ?: \lti_get_ims_role($user, $cmid, $course->id, $is_lti_2);
}
...
class LtiConfigurationTest extends \PHPUnit\Framework\TestCase {
  ...
  /**
   * @var function $mock_require_local_lib require file stub
   */
  public static $mock_require_local_lib;

  /**
   * @var string $mock_ims_role semi-colon delimited list of roles
   */
  public static $mock_ims_role;
  ...
  protected function setUp()
  {
    ...
    self::$mock_require_local_lib = function(){};
    self::$mock_ims_role = "ims:teacher";
  ...
  public function testGetRoleNames(){
    ...
    $this->assertEquals(
      array(self::$mock_ims_role, self::$mock_user_role_name, self::$mock_admin_list[0]['name']),
      $role_names
    );
  }
  ...
  public function testSanitizeRolesAdmin() {
    $admin_roles = array(
