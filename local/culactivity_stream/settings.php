...
if ($hassiteconfig) { // needs this condition or there is error on login page
    ...
    $settings->add(new admin_setting_configselect('messagingdeleteactivityfeeddelay', new lang_string('messagingdeleteactivityfeeddelay', 'local_culactivity_stream'), new lang_string('configmessagingdeleteactivityfeeddelay', 'local_culactivity_stream'), 604800, $options));
}    