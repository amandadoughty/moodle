...
$renderer = $PAGE->get_renderer('local_culcourse_dashboard');
...
if ($PAGE->user_is_editing()) {
    $PAGE->requires->string_for_js('moveactivitylink', 'local_culcourse_dashboard');
    $PAGE->requires->string_for_js('movequicklink', 'local_culcourse_dashboard');
