...
class submissions_downloaded extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventsubmissions_downloaded', 'mod_peerassessment');
    }

    public function get_description() {
        return "The user with id '{$this->userid}'' downloaded the submissions for the 'peerassessment'
        activity with course module id '{$this->contextinstanceid}'.";
    }

    public function get_url() {
        return new \moodle_url(
            '/mod/peerassessment/downloadallsubmissions.php',
            array(
