...
Step 1: calculating the rating given by Student A to Student B
    ...
    Start by calculating the average as for the other two methods.  If Student A has been mean, the ratings he/she has given are increased; if over-generous, they are reduced. Having done this, the average rating awarded by student A is the same as the average awarded by all other students.
