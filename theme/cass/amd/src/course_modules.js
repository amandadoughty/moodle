    ...
    function($, ajax, util, ajaxNotify, str) {
            ...
            var lightbox = function(appendto, onclose) {
                ...
                if (lbox.length === 0) {
                    $(appendto).append('<div id="cass-light-box" tabindex="-1">' +
                        ...
                        '<a id="cass-light-box-close" class="pull-right cass-action-icon cass-icon-close" href="#">' +
                        '<small>Close</small>' +
                        '</a>' +
                        '</div>');
        ...
        return {
            ...
            init: function() {
                ...
                $(document).on('click', '.js-cass-media .cass-asset-link [href*="/mod/resource/view.php?id="]', function(e) {
                ...
                $(document).on('click', '.cass-resource-card .cass-resource', function(e) {
                    ...
                    var selector = '.cass-asset-completion-tracking, .cass-asset-actions, .contentafterlink a, .ally-actions';
