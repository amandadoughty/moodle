...
/**
 * Overridden JS (overridden to call theme version of ajax_response_renderer)
 * Load the site admin nav tree via ajax and render the response.
 *
 * @module     theme_cul_boost/site_admin_loader
 * @package    theme
 * @copyright  2020 Amanda Doughty
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
define(['jquery', 'core/ajax', 'core/config', 'theme_cul_boost/ajax_response_renderer'],
