 ...
 * @copyright 2018 Stephen Sharoe, Synergy Learning
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */

defined('MOODLE_INTERNAL') || die();

class theme_cul_boost_admin_settingspage_tabs extends admin_settingpage {
    ...
    public function output_html() {
        ...
        return $OUTPUT->render_from_template('theme_cul_boost/admin_setting_tabs', $context);
    }
